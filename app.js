...
let myName = prompt("Is my name Chris? Please answer yes/no or y/n only").toLowerCase();

while (myName != "yes" && myName != "no" && myName != "y" && myName != "n") {
  alert("Please answer yes/no or y/n only");
  myName = prompt("Is my name Chris? Please answer yes/no or y/n only").toLowerCase();
}

if (myName === "yes" || myName === "y") {
  // console.log("Correct, my name is Chris");
  alert("Correct, my name is Chris");
